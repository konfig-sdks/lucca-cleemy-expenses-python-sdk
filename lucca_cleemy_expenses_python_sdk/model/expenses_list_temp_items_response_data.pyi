...
class ExpensesListTempItemsResponseData(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ExpenseTempItem']:
                        return ExpenseTempItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ExpenseTempItem'], typing.List['ExpenseTempItem']],
                ...
                def __getitem__(self, i: int) -> 'ExpenseTempItem':
